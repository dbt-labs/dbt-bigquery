...
class BigQueryOptionsService:
    ...
    def table(
        ...
        opts = self.common(config, node, temporary)
    ...
    def view(self, config: Dict[str, Any], node: Dict[str, Any]) -> Dict[str, Any]:
        return self.common(config, node)
